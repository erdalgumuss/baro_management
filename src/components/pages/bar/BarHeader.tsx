...
const navItems = [
  { name: 'Başvurular', href: '/dashboard/basvurular' },
  { name: 'Davalar', href: '/dashboard/davalar' },
  { name: 'Avukat Yönetimi', href: '/dashboard/avukat-yonetimi' },
  { name: 'Hak İhlalleri', href: '/dashboard/hak-ihlalleri' },
  { name: 'Raporlama', href: '/dashboard/raporlama' }
]
