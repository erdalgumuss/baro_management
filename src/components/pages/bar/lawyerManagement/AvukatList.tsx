            ...
            >
              ...
              <TableCell>
                <div className="flex space-x-2">
                  <Button variant="outline" onClick={(e) => { e.stopPropagation(); onSelectLawyer(lawyer); }} className="bg-gray-700 text-gray-100 hover:bg-gray-600">
                    Düzenle
                  </Button>
                  <Button variant="destructive" onClick={(e) => { e.stopPropagation(); onDeleteLawyer(lawyer.id); }} className="bg-red-700 text-gray-100 hover:bg-red-600">
                    Sil
                  </Button>
                </div>
              </TableCell>
