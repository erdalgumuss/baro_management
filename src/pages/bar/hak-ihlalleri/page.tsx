...
import HakIhlaliAramaFiltre from '@/components/pages/bar/rightsViolation/HakIhlaliAramaFiltre'
import HakIhlaliListesi from '@/components/pages/bar/rightsViolation/HakIhlaliListesi'
import HakIhlaliDetay from '@/components/pages/bar/rightsViolation/HakIhlaliDetay'
import HakIhlaliKategoriIzleme from '@/components/pages/bar/rightsViolation//HakIhlaliKategoriIzleme'
import HakIhlaliKaynakEntegrasyonu from '@/components/pages/bar/rightsViolation//HakIhlaliKaynakEntegrasyonu'
import HakIhlaliSonuclandirma from '@/components/pages/bar/rightsViolation//HakIhlaliSonuclandirma'
