...
import { DavaSureci } from "./DavaDetay/DavaSureci"
import { BelgeYonetimi } from "./DavaDetay/BelgeYonetimi"
import { DurusmaTakvimi } from "./DavaDetay/DurusmaTakvimi"
import { IletisimAlani } from "./DavaDetay/IletisimAlani"

interface DavaDetayProps {
  dava: any
  isOpen: boolean
  onClose: () => void
}

export function DavaDetay({ dava, isOpen, onClose }: DavaDetayProps) {
