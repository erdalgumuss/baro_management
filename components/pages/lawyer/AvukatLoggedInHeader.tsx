...
const navItems = [
  { name: 'Davalar', href: '/lawyer/davalar' },
  { name: 'Başvurular', href: '/lawyer/basvurular' },
  { name: 'Takvim', href: '/lawyer/takvim' },
  { name: 'Performans ve İstatistikler', href: '/lawyer/performans-istatistikler' }
]
