...
export default function ApplicationList({ applications = [], onUpdateApplication, onDavaSelect }) {
        ...
        <TableBody>
          {applications.map((application) => (
            <TableRow
              ...
              onClick={() => onDavaSelect(application)} // Modal açma işlevini tetikler
            >
              ...
              <TableCell>
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation() // Modal tetiklenmesini engeller
