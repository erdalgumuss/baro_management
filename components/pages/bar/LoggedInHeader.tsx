...
const navItems = [
  { name: 'Başvurular', href: '/bar/application' },
  { name: 'Davalar', href: '/bar/davalar' },
  { name: 'Avukat Yönetimi', href: '/bar/avukat-yonetimi' },
  { name: 'Hak İhlalleri', href: '/bar/hak-ihlalleri' },
  { name: 'Raporlama', href: '/bar/raporlama' }
]
