...
import DavaOzet from './caseDetails/DavaOzet'
import DavaTaraflar from './caseDetails/DavaTaraflar'
import DavaDurumu from './caseDetails/DavaDurumu'
import AvukatYonetimi from './caseDetails/AvukatYonetimi'
import DavaBelgeleri from './caseDetails/DavaBelgeleri'
import HakIhlali from './caseDetails/HakIhlali'
import DavaIletisim from './caseDetails/DavaIletisim'
import DavaGecmisi from './caseDetails/DavaGecmisi'
import DavaKapanis from './caseDetails/DavaKapanis'
import DavaIstatistikleri from './caseDetails/DavaIstatistikleri'

export default function caseDetails({ dava, onClose, onUpdate }) {
